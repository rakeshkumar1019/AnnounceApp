...
public class Helper {
    ...
    public static String DB_SOURCE =  "jdbc:mysql://jspdiary.cgerml78x6pf.ap-south-1.rds.amazonaws.com:3306/jspDiary?useSSL=false&serverTimezone=UTC&user=admin&password=adminuser&charset=UTF-8";
